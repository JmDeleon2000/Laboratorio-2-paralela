...
void quicksort(int *data, int lo, int hi) //}, int (*compare)(const int *, const int*))
{
  ...
  //recursive call
#pragma omp task if (h-lo > 100) mergeable
  quicksort(data, lo, h);
